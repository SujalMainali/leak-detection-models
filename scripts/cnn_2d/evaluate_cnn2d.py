...
from models.cnn_2d.utils import evaluate_targets, save_metrics, save_metrics_json
...
def main() -> None:
    ...
    if not test_pred_path.exists():
        raise FileNotFoundError(
            f"Missing predictions file: {test_pred_path}. Run scripts/cnn_2d/predict_cnn2d.py first."
        )
